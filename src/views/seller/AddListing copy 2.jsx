                                        ...
                                        {/* <form onSubmit={save}> */}
                                            <div className="flex md:flex-col md:gap-2 w-full gap-5 text-slate-600">
                                                <div className="flex flex-col gap-1 mb-2 w-full">
                                                    ...
                                                    <input onChange={inputHandler} value={state.location_name} className='w-full bg-transparent px-4 py-2 focus:border-accent outline-none bg-[#283046] border-2 border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='location_name' placeholder='name' id='location_name' />
                                                </div>
                                                <div className="flex flex-col gap-1 mb-2 w-full">
