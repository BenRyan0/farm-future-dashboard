...
import { commodityAdd,messageClear,adminCommodityPriceAdd,get_seller_commodities} from '../../store/Reducers/commodityReducer';
...
if(errorMessage){
    ...
    dispatch(get_seller_commodities(obj))
}
