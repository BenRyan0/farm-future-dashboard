...
const SellerToCustomer = () => {
    ...
    // Emit the message via WebSocket and clear the success message
    useEffect(() => {
    ...
    // Update Redux state or show toast notification for incoming messages
    useEffect(() => {
        if (receivedMessage) {
    ...
    }, [receivedMessage, customerId, userInfo, dispatch]);
                            ...
                            customers.map((c,i)=>
                                ...
                                <Link key={i} to={`/seller/dashboard/chat-customer/${c.fdId}`}  className={`h-[60px] flex justify-start gap-2 items-center text-text_color px-2 py-2 rounded-md cursor-pointer bg-slate-700`}>
                                    <div className="relative">
                                        <img className='w-[45px] h-[45px] border-white border-2 max-w-[50px] p-[2px] rounded-full'  src="/images/Placeholders/seller_profile_placeholder.png" alt="" />
                                        {
                    ...
                    <div className="flex justify-between items-center">
                        {
                            customerId && <div className="flex justify-start items-center gap-3">
                                <div className="relative">
                                    <img className='w-[45px] h-[45px] border-green-500 border-2 max-w-[50px] p-[2px] rounded-full' src="/images/Placeholders/seller_profile_placeholder.png" alt="" />
                                    {
