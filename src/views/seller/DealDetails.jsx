...
const DealDetails = () => {
  ...
  const statusUpdate = (e) => {
    ...
    console.log("STATUS________________________")
    console.log(status)

    if(status === "confirmed"){
        dispatch(seller_order_status_update({orderId, info: {status}, transaction: {}, id: userInfo._id}))
    ...
    navigate('/seller/dashboard/deals')
    dispatch(messageClear())
  ...
  return (
    ...
    <div className="w-full p-4 bg-[#283046] rounded-md">
       ...
       <div className="">
           <form action="" onSubmit={statusUpdate}>
