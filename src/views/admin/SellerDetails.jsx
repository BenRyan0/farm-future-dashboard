         ...
         <div className="w-full p-4 bg-[#283046] rounded-md">
            <div className="w-full flex flex-wrap text-text_color ">
                ...
                {/* <div className="w-full px-3 flex justify-between gap-2">
                    {
                        seller.credential_img01 && <div className="">
                            <img src={`${seller.credential_img01}`} alt="" />
                        </div>
                    }
                    {
                        seller.credential_img02 && <div className="">
                            <img src={`${seller.credential_img02}`} alt="" />
                        </div>
                    }
                    {
                        seller.credential_img03 && <div className="">
                            <img src={`${seller.credential_img03}`} alt="" />
                        </div>
                    }
