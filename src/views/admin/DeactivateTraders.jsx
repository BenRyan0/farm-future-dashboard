...
import {get_active_sellers, get_deactive_sellers} from '../../store/Reducers/sellerReducer'



const DeactivateTraders = () => {
                            ...
                            <tbody className='text-xs'>
                                {
                                    sellers.map((d,i)=> 
                                        <tr key={i}>
                                            ...
                                            <td scope='row' className='py-1 pl-4 font-medium whitespace-nowrap'>
                                                <span className='text-red-400 font-semibold`'>{d.status}</span>
                                            </td>
                                            <td scope='row' className='py-1 pl-4 font-medium whitespace-nowrap'>
                                                <span>{d.email}</span>
                                            </td>
                                            ...
                                            <td scope='row' className='py-1aaaaa px-4 font-medium whitespace-nowrap'>
                                               <div className="flex justify-start items-center gap-4">
                                                    <Link to={`/admin/dashboard/seller/details/${d._id}`} className='flex justify-center items-center p-2 bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50'><IoEyeSharp />view</Link>
...
export default DeactivateTraders